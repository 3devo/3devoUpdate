/*
 * This file is a direct copy of https://docs.microsoft.com/en-us/dotnet/api/system.icustomformatter.format
 * Only the spaces between byte characters are removed.
 */
